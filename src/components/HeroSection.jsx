    ...
    <section className="relative h-[80vh] flex flex-col items-center justify-center text-white px-4 overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-blue-50 max-w-2xl mx-auto opacity-90">
          Find the best university according to your academic score and budget.
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          <div>
            ...
            <select className="w-full bg-white text-gray-800 p-3 rounded-xl focus:ring-2 focus:ring-cyan-400 outline-none transition-all cursor-pointer">
          ...
          <button className="bg-cyan-500 hover:bg-cyan-400 text-white font-bold py-3 px-6 rounded-xl shadow-lg shadow-cyan-500/30 transition-all active:scale-95 text-center">
            Search Universities
          </button>
        </div>
      </motion.div>
